    ...
    return (
        <>
                ...
                {active && (
                    ...
                    >
                        <motion.div
                            ...
                            ref={cardRef}
                            className="w-full max-w-[850px] h-full flex flex-col overflow-auto [scrollbar-width:none] [-ms-overflow-style:none] [-webkit-overflow-scrolling:touch] sm:rounded-t-3xl bg-zinc-50 shadow-sm dark:shadow-none dark:bg-zinc-950 relative"
                            {...props}
                        >
                                ...
                                <div className="flex justify-between items-start p-8 h-auto">
                                    ...
                                    <div className="flex items-center gap-3">
                                        <a
                                            ...
                                            className="text-zinc-500 hover:text-green-400 dark:text-zinc-400 dark:hover:text-green-400 transition-colors"
                                        >
                                            <Globe size={24} />
                                        </a>
                                        <motion.button
            ...
            <motion.div
                ...
                className="p-3 flex flex-col justify-between items-center bg-zinc-50 shadow-sm dark:shadow-none dark:bg-zinc-950 rounded-2xl cursor-pointer border border-gray-200/70 dark:border-zinc-900"
            >
